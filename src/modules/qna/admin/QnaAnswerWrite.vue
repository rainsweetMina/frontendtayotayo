<template>
  <div>
    <!-- Breadcrumb -->
    <AppBreadcrumb breadcrumb="Q&A 답변작성" />
    <div class="mt-4">
      <div class="p-6 bg-white rounded-md shadow-md">
        <h2 class="text-lg font-semibold text-gray-700 capitalize mb-4">QnA 답변 작성</h2>
...
const handleSubmit = async () => {
  try {
    ...
    showSuccessModal('답변이 저장되었습니다.')
  } catch (e) {
    showErrorModal('답변 저장에 실패했습니다.')
  }
}
